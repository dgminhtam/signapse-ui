---
name: shadcn
description: Use when adding, fixing, debugging, styling, or composing shadcn/ui components in this project. Covers registries, CLI usage, component composition rules, and semantic token-based styling.
---
...
> **IMPORTANT:** This repo uses `pnpm`. Prefer `pnpm dlx shadcn@latest ...` for all CLI examples and commands.
