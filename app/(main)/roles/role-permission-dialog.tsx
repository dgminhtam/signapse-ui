          ...
          <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
            ...
            <div className="flex flex-wrap items-center gap-2 lg:justify-end">
              <Badge variant="outline">
                {standardPermissionCount} quyền trong catalog
              </Badge>
              <Badge variant="outline">
                  ...
                  <div className="flex flex-col gap-3 px-4 py-4 sm:flex-row sm:items-start sm:justify-between">
                    <div className="flex min-w-0 items-start gap-3">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Những quyền này không còn xuất hiện trong catalog hiện
                          tại nhưng vẫn sẽ được giữ nguyên khi bạn lưu thay đổi.
                        </p>
                      </div>
                    </div>
                    ...
                    <CollapsibleTrigger asChild>
                      <Button type="button" variant="ghost" size="sm">
                        ...
                        />
                        {normalizedQuery
                          ? "Đang mở vì có kết quả tìm kiếm"
                          : "Xem chi tiết"}
                      </Button>
                    </CollapsibleTrigger>
                  </div>
            ...
            legacyPermissionKeys.length === 0 ? (
              <div className="rounded-xl border border-dashed bg-muted/15 px-4 py-4 text-sm text-muted-foreground">
                <div className="flex items-start gap-3">
                  ...
                  <span>
                    Bạn có thể tìm kiếm theo từ khóa, hoặc thao tác theo từng
                    nhóm để cập nhật quyền nhanh hơn.
                  </span>
                </div>
              </div>
            ) : null}
