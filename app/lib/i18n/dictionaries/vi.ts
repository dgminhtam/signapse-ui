export const vi = {
  ...
  aiAssistant: {
    ...
    enterFullscreen: "Mở rộng trợ lý AI",
    exitFullscreen: "Thoát chế độ mở rộng trợ lý AI",
    title: "Trợ lý AI Signapse",
    newThread: "Hội thoại mới",
    persistedThread: "Hội thoại đã lưu",
    welcomeTitle: "Trợ lý thị trường",
    welcomeDescription:
      "Đặt câu hỏi thị trường hoặc chọn hội thoại đã lưu từ lịch sử.",
    newConversation: "Hội thoại mới",
    history: "Lịch sử hội thoại",
    historyTitle: "Hội thoại gần đây",
    historyEmpty: "Chưa có hội thoại đã lưu.",
    loadMoreHistory: "Tải thêm hội thoại",
    loadOlderMessages: "Tải tin nhắn cũ hơn",
    loadingMessages: "Đang tải tin nhắn",
    messageLabel: "Tin nhắn",
    messagePlaceholder: "Đặt câu hỏi về thị trường",
    composerHint: "Enter để gửi. Shift+Enter để xuống dòng.",
    unavailable: "Tính năng nhắn tin tại đây chưa khả dụng",
    placeholderNote: "Placeholder này không gửi hoặc lưu tin nhắn.",
    pending: "Đang suy nghĩ",
    retry: "Thử lại",
    messageFailed: "Tin nhắn thất bại.",
    emptyMessage: "Không có nội dung tin nhắn.",
    send: "Gửi tin nhắn",
    loading: "Đang tải trợ lý AI",
    error: "Không thể tải trợ lý AI.",
    analysis: {
      available: "Phân tích thị trường",
      showDetails: "Xem chi tiết phân tích",
      hideDetails: "Ẩn chi tiết phân tích",
      preparing: "Chi tiết phân tích sẽ có khi quá trình xử lý hoàn tất.",
      unavailable: "Chi tiết phân tích hiện không khả dụng.",
      loading: "Đang tải chi tiết phân tích...",
      loadError: "Không thể tải chi tiết phân tích.",
      retry: "Thử lại",
      failed: "Phân tích thất bại.",
      confidence: "Độ tin cậy",
      model: "Model",
      assets: "Tài sản đã xét",
      limitations: "Giới hạn",
      keyEvents: "Sự kiện trọng yếu",
  ...
  marketConversations: {
    ...
    analysis: {
      ...
      model: "Model",
      limitations: "Giới hạn",
      limitationsEmpty: "Chưa lưu giới hạn nào.",
      assets: "Tài sản đã xét",
      assetsEmpty: "Chưa lưu tài sản nào.",
      reasoning: "Chuỗi tổng hợp",
      reasoningEmpty: "Chưa lưu chuỗi tổng hợp.",
      keyEvents: "Sự kiện trọng yếu",
      keyEventsEmpty: "Chưa lưu sự kiện trọng yếu.",
      keyNarratives: "Luận điểm trọng yếu",
      keyNarrativesEmpty: "Chưa lưu luận điểm trọng yếu.",
    },
    evidence: {
      open: "Bằng chứng",
      title: "Snapshot bằng chứng",
      description:
        "Bằng chứng đã lưu cùng phân tích này. Mở drawer này không chạy lại truy xuất.",
      ...
      openExternal: "Mở nguồn",
      sourceTypeLabels: {
        EVENT: "Sự kiện",
        NARRATIVE: "Luận điểm",
        NEWS_ARTICLE: "Bài viết tin tức",
        EVENT_NEWS_ARTICLE_EVIDENCE: "Bằng chứng sự kiện",
        ECONOMIC_CALENDAR_ENTRY: "Lịch kinh tế",
      },
      roleLabels: {
        PRIMARY: "Chính",
        SUPPORTING: "Hỗ trợ",
    ...
    telegram: {
      ...
      send: "Gửi Telegram",
      sending: "Đang gửi...",
      sent: "Đã gửi phân tích tới Telegram.",
      duplicate: "Phân tích này đã được gửi tới đích đó.",
      sendError: "Chưa thể gửi phân tích tới Telegram.",
    },
  },
  marketCharts: {
    readDenied:
