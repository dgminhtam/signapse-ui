export const vi = {
  ...
  navigation: {
    ...
    feedbackModeration: "Phản hồi người dùng",
  },
  feedback: {
    ...
    fixtureUser: "Người dùng thử nghiệm",
    composeTitle: "Gửi phản hồi",
    composeDescription:
      "Mô tả rõ lỗi hoặc ý tưởng. Biểu mẫu fixture này không gửi dữ liệu tới dịch vụ thật.",
    ...
    historyErrorDescription: "Hãy thử lại để tải danh sách phản hồi fixture.",
    ...
    withdrawDescription:
      "Phản hồi sẽ bị xóa khỏi lịch sử fixture của bạn và không thể hoàn tác tại đây.",
    ...
    eraseDescription:
      "Bản ghi fixture sẽ bị xóa khỏi mọi màn hình phản hồi. Đây là thao tác có tính hủy.",
    ...
    moderationFixtureNote: "Màn hình fixture-only; không gọi API thật.",
  ...
  landing: {
    ...
    hero: {
      eyebrow: "Event-aware market intelligence",
      sectionLabel: "Bằng chứng sản phẩm",
      title: "Đọc biến động thị trường trong bối cảnh sự kiện.",
      body: "Signapse kết hợp dữ liệu giá với sự kiện, phản ứng, nguồn tin và quan hệ thị trường liên quan khi dữ liệu khả dụng.",
    ...
    cta: {
      ...
      exploreJourney: "Xem cách hoạt động",
      exploreJourneyAria: "Xem cách Signapse hỗ trợ phân tích",
    ...
    metadata: {
      ...
      socialImageAlt: "Signapse | Phân tích thị trường theo bối cảnh sự kiện",
    },
  },
  personalNotes: {
    trigger: "Ghi chú",
