...
export const en: Dictionary = {
  ...
  navigation: {
    ...
    feedbackModeration: "User feedback",
  },
  feedback: {
    ...
    composeDescription:
      "Share a clear bug report or idea. This fixture form does not send data to a live service.",
    ...
    historyErrorDescription: "Try again to load the fixture feedback list.",
    ...
    withdrawDescription:
      "This removes the feedback from your fixture history and cannot be undone here.",
    ...
    eraseDescription:
      "This removes the fixture record for every feedback view. The action is destructive.",
    ...
    moderationFixtureNote: "Fixture-only surface; no live API request is made.",
  ...
  landing: {
    ...
    hero: {
      ...
      sectionLabel: "Product proof",
      title: "Read market moves in the context of events.",
      body: "Signapse brings price data together with related market events, reactions, sources, and relationships when available.",
    ...
    metadata: {
      title: "Signapse | Event-aware market intelligence",
      description:
        "Signapse brings price data together with related market events, reactions, sources, and relationships when available.",
      socialImageAlt: "Signapse | Event-aware market intelligence",
    },
  },
  personalNotes: {
    trigger: "Notes",
