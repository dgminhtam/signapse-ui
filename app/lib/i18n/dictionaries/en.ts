...
export const en: Dictionary = {
  ...
  personalNotes: {
    ...
    createError: "Could not create note",
    ...
    emptyDescription:
      "Create the first note to save formulas or trade commands.",
    untitled: "Untitled note",
    emptyPreview: "No content to preview yet.",
    loadedSavedNote: "Saved note loaded",
    unsaved: "Unsaved",
    saving: "Saving...",
    dirty: "Unsaved changes",
    discardTitle: "Discard unsaved changes?",
    discardDescription:
      "The content you edited has not been saved. If you continue, these changes will be lost.",
  ...
  newsArticles: {
    ...
    linkedEventsTitle: "Linked events",
    linkedEventsEmptyTitle: "No linked events yet",
    linkedEventsEmptyDescription:
      "This article has no linked events in the current data.",
    contentTitle: "Content",
    contentEmpty: "No detailed content yet.",
    quickContentEmpty: "This article has no detailed content yet.",
    ...
    evidenceConfidence: "Evidence confidence: {value}",
    noConfidence: "N/A",
  ...
  aiAssistant: {
    ...
    enterFullscreen: "Expand AI assistant",
    exitFullscreen: "Exit expanded AI assistant",
    title: "Signapse AI assistant",
    newThread: "New conversation",
    persistedThread: "Saved conversation",
    welcomeTitle: "Market assistant",
    welcomeDescription:
      "Ask a market question or choose a saved conversation from history.",
    ...
    messagePlaceholder: "Ask a market question",
    composerHint: "Enter sends. Shift+Enter adds a new line.",
    unavailable: "Messaging is not available here yet",
    placeholderNote: "This placeholder does not send or save messages.",
    pending: "Thinking",
    retry: "Try again",
  ...
  marketConversations: {
    ...
    analysis: {
      ...
      model: "Model",
      limitations: "Limitations",
      limitationsEmpty: "No limitations were saved.",
      assets: "Assets considered",
      assetsEmpty: "No assets were saved.",
      reasoning: "Reasoning chain",
      reasoningEmpty: "No reasoning chain was saved.",
      keyEvents: "Key events",
      keyEventsEmpty: "No key events were saved.",
      keyNarratives: "Key narratives",
      keyNarrativesEmpty: "No key narratives were saved.",
    },
    evidence: {
      open: "Evidence",
      title: "Evidence snapshot",
      description:
        "Persisted evidence saved with this analysis. Opening this drawer does not rerun retrieval.",
      loading: "Loading evidence...",
      loadError: "Could not load evidence.",
      errorTitle: "Evidence could not load",
      emptyTitle: "No evidence saved",
      emptyDescription:
        "No persisted evidence snapshot was saved for this analysis.",
      untitled: "Untitled evidence",
      sourceMissing: "Source not available",
      openInternal: "Open detail",
      openExternal: "Open source",
      sourceTypeLabels: {
        EVENT: "Event",
        NARRATIVE: "Narrative",
        NEWS_ARTICLE: "News article",
        EVENT_NEWS_ARTICLE_EVIDENCE: "Event evidence",
        ECONOMIC_CALENDAR_ENTRY: "Economic calendar",
      },
      roleLabels: {
        PRIMARY: "Primary",
        SUPPORTING: "Supporting",
    ...
    telegram: {
      destinationLabel: "Telegram destination",
      destinationPlaceholder: "Choose destination",
      destinationRequired: "Choose a Telegram destination.",
      noDestinations:
        "No active Telegram destination is available for manual delivery.",
      setup: "Open Telegram setup",
      send: "Send to Telegram",
      sending: "Sending...",
      sent: "Analysis sent to Telegram.",
      duplicate: "This analysis was already sent to that destination.",
      sendError: "Could not send the analysis to Telegram.",
    },
  },
  marketCharts: {
    readDenied:
  ...
  editor: {
    ...
    toolbar: {
      ...
      fontFamilyOptions: "Formatting options for font family",
      fontSize: "Font size",
      ...
      redo: "Redo",
      undoMac: "Undo (⌘Z)",
      undoWindows: "Undo (Ctrl+Z)",
      redoMac: "Redo (⇧⌘Z)",
      redoWindows: "Redo (Ctrl+Y)",
    ...
    insert: {
      ...
      insertColumnsLayout: "Insert columns layout",
    ...
    colorPicker: {
      ...
      alphaPercentage: "Alpha transparency percentage",
      redComponent: "Red color component (0-255)",
      greenComponent: "Green color component (0-255)",
      blueComponent: "Blue color component (0-255)",
      hueDegree: "Hue degree (0-360)",
      saturationPercentage: "Saturation percentage (0-100)",
      lightnessPercentage: "Lightness percentage (0-100)",
      brightnessPercentage: "Brightness percentage (0-100)",
      eyeDropper: "Pick color from screen",
    },
    image: {
      urlLabel: "Image URL",
      urlPlaceholder: "Example: https://source.unsplash.com/random",
      altLabel: "Alt text",
      altPlaceholder: "Short image description",
      uploadLabel: "Image upload",
      uploadAltPlaceholder: "Descriptive alternative text",
      urlTab: "URL",
      fileTab: "File",
      brokenAlt: "Broken image",
    },
    media: {
      audio: "Audio",
      file: "File",
    ...
    table: {
      rows: "Rows",
      columns: "Columns",
      rowsPlaceholder: "Number of rows (1-500)",
      columnsPlaceholder: "Number of columns (1-50)",
      sizeOption: "{rows}x{columns} table",
    },
    picker: {
      filterBlocks: "Filter blocks...",
      noResults: "No results found.",
      addBlock: "Click to add below (Alt/Ctrl: add above)",
    },
    layout: {
      twoEqual: "2 columns (equal width)",
      twoQuarter: "2 columns (25% - 75%)",
      threeEqual: "3 columns (equal width)",
      threeMixed: "3 columns (25% - 50% - 25%)",
    ...
    speechToText: {
      ...
      disable: "Disable speech to text",
    },
    clearEditor: {
      title: "Clear editor",
      description: "Are you sure you want to clear the editor?",
      cancel: "Cancel",
      clear: "Clear",
    },
    treeView: {
    ...
    share: {
      ...
      copyError: "URL could not be copied to clipboard.",
      title: "Share",
      aria: "Share link to current editor state",
      tooltip: "Share content",
    },
    editMode: {
      readOnlyTitle: "Read-only mode",
      unlock: "Unlock read-only mode",
      lock: "Lock read-only mode",
    ...
    importExport: {
      importTitle: "Import",
      exportTitle: "Export",
      importAria: "Import editor state from JSON",
      exportAria: "Export editor state to JSON",
      importTooltip: "Import content",
      exportTooltip: "Export content",
      fileNamePrefix: "Editor",
      source: "Editor",
    },
    contextMenu: {
      pasteDenied: "Not allowed to paste from clipboard.",
