...
export const en: Dictionary = {
  ...
  marketQuery: {
    ...
    evidence: {
      ...
      sourceDocumentUntitled: "Untitled source document",
      sourceDocumentMissing: "No source document",
      outletMissing: "None",
    ...
    format: {
      ...
      blockedEventAndSource:
        "You do not have permission to open the related event or source document details.",
      blockedEvent:
        "You do not have permission to open the related event details.",
      blockedSourceDocument:
        "You do not have permission to open the related source document.",
      eventFallback: "Event ID #{id}",
      sourceDocumentFallback: "Source document ID #{id}",
    },
    confidenceUnknown: "Not available",
    artifactTypes: {
      NEWS_ARTICLE: "News source document",
