---
name: accessibility
description: Audit and improve web accessibility following WCAG 2.2 guidelines. Use when asked to improve accessibility, run an a11y audit, improve WCAG compliance, add screen reader support, fix keyboard navigation, or make a UI accessible.
license: MIT
metadata:
...
Use this skill when working on accessibility-sensitive UI or when the user explicitly asks for accessibility improvements.
