# browser-test-foundation Specification

## Purpose

Define the secret-free, fixture-backed P0 browser test foundation for critical Signapse UI workflows, with deterministic evidence, accessibility checks, visual baselines, and explicit separation from real authentication and external delivery verification.
