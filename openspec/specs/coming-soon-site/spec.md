# coming-soon-site Specification

## Purpose

Define the temporary, independently served Signapse launch surface for the
`signapse.cloud` apex domain while preserving the existing development
application at `dev.signapse.cloud`.
