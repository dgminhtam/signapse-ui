# plate-toolbar-dropdown-sizing Specification

## Purpose
Keep text-bearing Plate toolbar dropdowns readable while preserving intentional compact sizing and the shared shadcn wrapper.
