# fullscreen-overlay-containment Specification

## Purpose

Defines the portal-containment policy that keeps local fullscreen overlays visible, interactive, and accessible inside their fullscreen surface.
