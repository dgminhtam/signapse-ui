...
The graph view SHALL apply selected-node and selected-relation visual states using a batched G6 state update.
...
- **AND** the graph view submits them to G6 as a single batched state update
