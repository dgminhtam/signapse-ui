# legacy-assistant-ui-removal Specification

## Purpose

Define the removal boundary for the unreachable Assistant UI application graph and repository-installed Assistant UI skills while preserving the active market-conversation implementation, unrelated tooling, and historical OpenSpec archives.
