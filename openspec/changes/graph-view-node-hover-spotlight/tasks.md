...
- [x] 4.2 Run typecheck.
- [ ] 4.3 Smoke test `/graph-view` in light mode: hover shows full title, related elements are emphasized, unrelated context remains visible, drag/pan/zoom still work.
- [ ] 4.4 Smoke test `/graph-view` in dark mode: labels and hover title remain readable and hover does not make the canvas visually muddy.
