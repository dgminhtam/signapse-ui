...
- [x] 5.3 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Smoke check pagination on a list with multiple pages, first page, last page, and during a pending transition if a local authenticated session is available.
