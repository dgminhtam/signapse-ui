...
- [x] 4.3 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Manually inspect `/news-articles/{id}` at desktop and mobile widths to confirm the reading order is summary, linked events, content, then technical information.
