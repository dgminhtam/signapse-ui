...
- [x] 7.4 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Smoke test desktop and narrow viewport header behavior, sidebar expanded/collapsed brand behavior, workspace switch, create, rename, and tracked-asset editor launch where local permissions/data allow it.
