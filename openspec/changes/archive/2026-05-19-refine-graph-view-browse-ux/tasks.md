...
- [x] 4.2 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Verify the refined graph-view experience on desktop and narrow layouts for canvas hierarchy, inspector behavior, clutter reduction, and bounded motion quality
