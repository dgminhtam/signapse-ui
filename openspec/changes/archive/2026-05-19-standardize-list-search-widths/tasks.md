...
- [x] 5.3 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Smoke check representative list pages at mobile and desktop widths: one action-heavy page, one no-create-action page, and one legacy toolbar page.
