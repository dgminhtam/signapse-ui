...
> **User-owned manual QA:** Kiểm tra Popover đúng vị trí gần marker và không bị clip; selected ring hoạt động; mobile fallback hiển thị; `LocalEntityQuickDetailDrawer` mở từ Popover; Popover đóng khi click outside hoặc chọn marker khác.
