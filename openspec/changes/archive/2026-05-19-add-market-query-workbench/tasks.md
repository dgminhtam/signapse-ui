...
- [x] 4.2 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Verify the workbench against a local backend response, including route gating, pending feedback, structured result rendering, empty sections, collapsed reasoning behavior, and permission-aware traceability links.
