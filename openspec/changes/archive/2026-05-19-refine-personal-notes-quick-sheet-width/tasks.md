...
- [x] 3.2 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Smoke-test opening the quick Sheet, selecting recent notes, creating a new note, saving, dirty discard confirmation, and opening the full `/notes` workspace.
