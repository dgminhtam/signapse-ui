...
**Reason**: The Chart Annotation / Market Query / Knowledge Graph pillar set is stale and conflicts with the verified runtime and canonical three-chapter story.

**Migration**: Use the modified `Landing page product story` requirement and the added `Landing page trust and claim boundaries` requirement.

### Requirement: Landing page V2 hero visual
**Reason**: The synthetic workspace preview contains unverifiable controls, metrics, and unsupported Market Query and graph treatments.

**Migration**: Use the modified `Landing page visual media readiness` requirement; the initial implementation is text-first and may add only independently approved captures later.

### Requirement: Landing page V2 intelligence flow
**Reason**: The internal pipeline and workspace-personalization narrative overstates runtime behavior and does not describe the canonical user journey.

**Migration**: Use the Analysis Flow and Workspace and Assistant scenarios in the modified `Landing page product story` requirement.

### Requirement: Landing page V2 trust guardrails
**Reason**: The V2-named requirement is superseded by a more complete canonical trust contract with explicit optional-data qualifiers and prohibited claims.

**Migration**: Use the added `Landing page trust and claim boundaries` requirement.
