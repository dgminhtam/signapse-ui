...
- [x] 5.4 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Smoke test marker visibility, marker click popup, popup close/reselect behavior, grouped markers, responsive fallback, and keyboard access when authenticated chart data or fixtures are available.
