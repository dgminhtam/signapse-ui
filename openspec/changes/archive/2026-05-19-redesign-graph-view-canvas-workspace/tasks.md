...
- [x] 4.2 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Verify the redesigned graph-view route for uncluttered default state, modal inspection flow, and stable hover behavior on desktop and narrow layouts
