...
- [x] 4.2 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Verify list/detail rendering for events and linked events against the local backend, including empty states, badges, traceability links, and operator toasts.
