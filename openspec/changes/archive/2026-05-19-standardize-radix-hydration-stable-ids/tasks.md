...
- [x] 3.2 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Reload the affected route in development and confirm the hydration warning no longer appears for the personal notes quick sheet trigger.
