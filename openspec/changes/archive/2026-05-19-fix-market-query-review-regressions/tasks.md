...
- [x] 6.4 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Smoke test `/market-query` manually with idle, running, success, error, empty evidence, and permission-restricted scenarios where local backend data allows it.
