...
- [x] 5.2 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Verify the route against a local backend payload, including permission gating, empty state, populated graph rendering, hover highlight, selection panel behavior, and permission-aware drill-down affordances.
