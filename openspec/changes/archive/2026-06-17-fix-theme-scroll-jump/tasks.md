...
- Verify annotation toggle vẫn hoạt động (user-owned manual QA).

## 4. Verification

- [x] 4.1 `pnpm typecheck` — không lỗi TypeScript
- [x] 4.2 `pnpm lint` — 0 errors, 28 warnings (pre-existing)
> **User-owned manual QA:** Test theme toggle không kéo scroll về đầu; timeframe/asset change vẫn reset data và scroll về cuối; annotation toggle vẫn load data mới.
