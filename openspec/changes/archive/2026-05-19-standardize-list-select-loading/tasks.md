...
- [x] 4.4 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Smoke-check sort and page-size transitions when a browser session is available. Not run in this session because no local browser/dev session was available.
