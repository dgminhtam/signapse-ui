...
- FROM: `Review actions require permission and fixture capability`
- TO: `Review actions require permission and pending status`
- FROM: `Administrative deletion is isolated and capability-gated`
- TO: `Administrative deletion is isolated and permission-gated`
