...
- [x] 6.4 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Smoke test `/market-charts` with at least one successful candle response, one empty/no-data response if available, and one invalid request.
