...
- [x] 3.4 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Smoke-check the `/news-outlets` list visually for toolbar state, table columns, compact homepage/RSS signals, active-state labels, tooltips, empty state, and skeleton alignment.
