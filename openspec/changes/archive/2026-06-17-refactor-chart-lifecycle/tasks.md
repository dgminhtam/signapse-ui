...
> **User-owned manual QA:** Kiểm tra chart init khi mount một lần; prop changes không dispose chart; drawings sống sót qua timeframe switch và theme toggle; lazy-history loading vẫn hoạt động khi scroll older candles.
