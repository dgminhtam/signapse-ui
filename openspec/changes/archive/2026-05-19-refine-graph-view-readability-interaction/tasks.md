...
- [x] 5.4 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Smoke-check graph view with a dense payload for default labels, hover full titles, drag behavior, anti-overlap, and reduced-motion fallback where possible.
