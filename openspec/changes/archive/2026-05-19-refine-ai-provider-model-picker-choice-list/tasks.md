...
- [x] 3.3 Manual QA transferred out of the agent-owned archive gate.
  User-owned manual QA: Smoke review the AI provider model picker dialog when a browser/authenticated local app state is available, checking that the list scrolls inside the dialog and selected radio choice cards match shadcn Nova.
