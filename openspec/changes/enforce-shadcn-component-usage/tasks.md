...
- [ ] 2.2 Verify the AI provider model picker keeps dialog content crisp above the backdrop while only the surrounding page is dimmed or blurred.
...
- [ ] 4.4 Smoke test the AI provider model picker dialog in the browser and confirm the overlay behavior matches the requirement.
