...
- **THEN** the documentation instructs them to verify that no active global `@quickDetail` slot or intercepted quick-detail route remains unless a future proposal explicitly reintroduces one
