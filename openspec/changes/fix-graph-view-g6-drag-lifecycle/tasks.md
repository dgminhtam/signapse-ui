...
- [ ] 3.3 Smoke-check `/graph-view` in development mode: drag a node, release it, and verify it stays fixed.
- [ ] 3.4 Smoke-check mount/remount or route navigation and verify the console no longer logs `[G6 v5.1.0] The graph instance has been destroyed`.
