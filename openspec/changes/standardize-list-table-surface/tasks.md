...
- [ ] 2.5 Leave hidden or redirected legacy list pages such as `topics`, `sources`, and `source-documents` out of the first rollout unless they are reactivated by separate work.
