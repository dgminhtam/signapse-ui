...
- [ ] 8.3 Smoke review create with one credential, create with multiple credentials, per-credential model validation, provider/base URL invalidation, edit metadata save, credential add/update/delete, set-default, list controls, and APIMAPPING alignment.
