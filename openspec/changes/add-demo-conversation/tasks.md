...
- [ ] 20.1 Use the installed small Button variants for the chat-title History trigger, New chat, and Close controls without overriding CardHeader spacing, then verify lint, typecheck, diff integrity, and strict OpenSpec.
