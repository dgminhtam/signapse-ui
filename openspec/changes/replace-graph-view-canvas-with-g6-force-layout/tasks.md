...
- [ ] 5.1 Smoke-check a dense payload renders through G6 with visible clusters and no hard canvas crash.
- [ ] 5.2 Smoke-check dragging one node causes connected or clustered nodes to react through force behavior.
- [ ] 5.3 Smoke-check zoom and pan behavior on the G6 canvas.
