...
- [ ] 4.4 Smoke-check light and dark sidebar states when a browser session is available. Not run in this session because no local browser/dev session was available.
