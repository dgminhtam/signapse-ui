...
- [ ] 7.6 Smoke check `/`, `/vi`, `/en`, `/vi/sign-in`, `/en/sign-in`, protected app redirects, language selector switching, representative list/detail pages, and quick-detail routes.
- [ ] 7.7 Smoke check backend calls from `/vi` and `/en` routes include matching `Accept-Language` headers.
