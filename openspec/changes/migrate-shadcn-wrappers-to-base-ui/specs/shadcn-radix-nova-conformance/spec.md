...
The system SHALL keep migrated files in `components/ui/*` aligned with the selected official Base UI Nova registry output while the migration is in progress.
