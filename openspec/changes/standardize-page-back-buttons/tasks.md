...
- [ ] 3.6 Visually smoke check representative create/detail pages for outline/default back button alignment where local auth/data allow it; otherwise document the blocker.
