export const fixtureContracts = [
  ...
  { method: "POST", path: "/feedback-submissions/{id}/promote", mapping: "promoteFeedback", status: 200 },
  { method: "POST", path: "/feedback-submissions/{id}/dismiss", mapping: "dismissFeedback", status: 200 },
