...
if (
  ...
  console.error(
    "P0 browser server requires SIGNAPSE_AUTH_MODE=disabled and SIGNAPSE_E2E_MODE=fixture."
  )
  process.exit(1)
}
...
const nextBundler =
  process.env.SIGNAPSE_E2E_NEXT_BUNDLER === "webpack"
    ? "--webpack"
    : "--turbopack"
const child = spawn(
  process.execPath,
  [nextCli, "dev", nextBundler, "--port", String(port)],
  {
    env: {
      ...process.env,
